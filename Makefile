...
# Programmer Settings
PROGRAMMER = arduino
PORT = COM3  # Adjust as needed for your system
BAUD = 57600
# BAUD = 115200
...
# Source Files
SRC = src/main.c drivers/gpio/gpio.c drivers/interrupt/external_interrupt.c drivers/timer/timer0.c drivers/timer/timer1.c drivers/timer/timer2.c drivers/pwm/pwm.c drivers/eeprom/eeprom.c drivers/adc/adc.c utils/delay.c  drivers/usart/usart.c drivers/senzor/senzor.c drivers/i2c/i2c.c drivers/lcd/lcd.c
